...
const SearchBar = () => {
    ...
    return (
        <div className={`flex items-center w-full justify-center transition-all duration-300 ${isOpen ? "absolute top-0 left-0 w-full bg-white  h-24 z-50" : "w-40"}`}>
            {isOpen ? (
                <form onSubmit={handleSearch} action="" className='relative flex items-center justify-center w-full '>
